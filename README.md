...
> [!IMPORTANT]
> ⭐ **حمایت از توسعه مداوم و حرفه‌ای پروژه (Give us a Star 🌟):**
> توسعه، اپدیت و افزودن امکانات جدید به **Nyx Panel** بر اساس **حمایت و تعداد ستاره‌های (Stars 🌟) شما در گیت‌هاب** به صورت **مداوم، حرفه‌ای و دائمی** انجام می‌شود! لطفاً با زدن دکمه **Star ⭐️** در بالای صفحه گیت‌هاب، از این پروژه آزاد حمایت کنید.
> 
> 💬 **گزارش باگ، پیشنهادات و ارتباط با تیم ساینت:**
> در صورت مشاهده هرگونه **باگ، پیشنهاد برای آپدیت‌های بعدی یا سوالات فنی**، مستقیماً از طریق **[کانال تلگرام تیم ساینت (t.me/cynetx)](https://t.me/cynetx)** با ما در ارتباط باشید. پاسخگوی تمام نظرات شما هستیم! 🚀
...
### 🧪 ۵. ابزار تست زنده اتصال TLS (`SNI Tester`)
- **ارزیابی زنده باز بودن SNI:** سنجش لایو اتصال TLS از روی سرور روی پورت ۴۴۳ به همراه نمایش میزان تأخیر (`ms`) و مشخصات گواهی.
