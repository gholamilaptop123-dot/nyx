...
### مشکل واقعی:
در قطعی‌های سنگین اینترنت ایران (مانند ساعات قطعی گسترده همراه اول و ایرانسل)، حتی با پیشرفته‌ترین پروتکل‌ها مانند `VLESS Reality` و `Packet Fragment`، اتصال کاربر به طور کامل قطع می‌شود و کاربر هیچ راه جایگزینی ندارد.
...
> [!NOTE]
> **پشتیبانی کامل از ویندوز سرور:** پنل Nyx علاوه بر لینوکس، به صورت کاملاً نیتیو روی سرورهای ویندوزی (`Windows Server 2016 / 2019 / 2022 / 10 / 11`) نیز نصب و اجرا می‌شود!
